...
/*发送部分*/
uint8_t NRF24L01_TxAddress[NRF24L01_ADDRESS_WIDTH] = {0x11, 0x22, 0x33, 0x44, 0x55};		//发送地址，固定5字节
uint8_t NRF24L01_TxPacket[NRF24L01_TX_PACKET_WIDTH];				//发送数据包
 
/*接收部分*/
uint8_t NRF24L01_RxAddress[NRF24L01_ADDRESS_WIDTH] = {0x11, 0x22, 0x33, 0x44, 0x55};		//接收通道0地址，固定5字节
...
void NRF24L01_W_CE(uint8_t BitValue)
{
    ...
    (BitValue!=0) ? DL_GPIO_setPins(NRF24L01_PORT,NRF24L01_CE_PIN) : DL_GPIO_clearPins(NRF24L01_PORT,NRF24L01_CE_PIN);
}
...
void NRF24L01_W_CSN(uint8_t BitValue)
{
    ...
    (BitValue!=0) ? DL_GPIO_setPins(NRF24L01_PORT,NRF24L01_CSN_PIN) : DL_GPIO_clearPins(NRF24L01_PORT,NRF24L01_CSN_PIN);
}
...
void NRF24L01_W_SCK(uint8_t BitValue)
{
    ...
    (BitValue!=0) ? DL_GPIO_setPins(NRF24L01_PORT,NRF24L01_SCK_PIN) : DL_GPIO_clearPins(NRF24L01_PORT,NRF24L01_SCK_PIN);
}
...
void NRF24L01_W_MOSI(uint8_t BitValue)
{
    ...
    (BitValue!=0) ? DL_GPIO_setPins(NRF24L01_PORT,NRF24L01_MOSI_PIN) : DL_GPIO_clearPins(NRF24L01_PORT,NRF24L01_MOSI_PIN);
}
...
{
	/*取MISO引脚的高低电平并返回*/
    if(DL_GPIO_readPins(NRF24L01_PORT,NRF24L01_MISO_PIN)!=0)return 1;
    else return 0;
}
...
void NRF24L01_Init(void)
{
	...
	NRF24L01_WriteRegs(NRF24L01_RX_ADDR_P0, NRF24L01_RxAddress, NRF24L01_ADDRESS_WIDTH);
...
uint8_t NRF24L01_Send(void)
{
	...
	NRF24L01_WriteRegs(NRF24L01_TX_ADDR, NRF24L01_TxAddress, NRF24L01_ADDRESS_WIDTH);
	
	/*接收通道0地址，此处必须也设置为发送地址，用于接收应答*/
	NRF24L01_WriteRegs(NRF24L01_RX_ADDR_P0, NRF24L01_TxAddress, NRF24L01_ADDRESS_WIDTH);
